...
Audit updated 2026-09-27. The catalog contains 29 atmospheres, 155 audio choices, and 123 source-tracked video choices.
...
| Japanese onsen | 5/5 | 3/3 | Replaced three generic audio layers with hot-spring, suikinkutsu, and warm-water recordings; uses three genuine hot-spring and Japanese onsen views |
...
| Elevator music | 6/6 | 3/3 | Pass; five CC BY lounge instrumentals, a reusable lobby-room layer, real moving elevators, and a glass-lift POV |
...
| Night drive | 5/5 | 13/13 | Pass; genuine in-car, windshield, highway, tunnel, rural, winter, coastal, and city views spanning Dubai, Los Angeles, and Shenzhen |
...
- Tests require five to eight audio choices and four distinct video choices per standard atmosphere, three for Onsen and Elevator Music, and thirteen for Night Drive.
...
- `MEDIA_LICENSES.json` records every active item, rights source, creator/provider, license, modifications, delivery variants, file sizes, and project-hosted file hashes.
