...
</style></head><body><main><a class="back" href="./">← Back to Atmosphere</a><h1>Audio credits</h1><p>${manifest.length} theme-matched audio files edited from ${uniqueCredits.length} openly licensed field recordings. Each file is normalized to a consistent listening level and remains available under the same license as its source.</p>
